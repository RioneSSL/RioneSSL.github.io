      ...
      <>
        ...
        <div className="school p-4 lg:p-10 bg-primary-1">
          ...
          <div className='ssl_team'>
            ...
            <div className='ssl_member'>
                <div className='member_face'><img src="/assets/memmbers/Matsumoto.PNG" className='rounded' alt="Matsumoto Yudai" /></div>
                <div className='member_name'>Matsumoto Yudai</div>
                <div className='member_th'>17期</div>
                <div className='member_introduction'>ソフト、回路も担当しています！</div>
              </div>
              <div className='ssl_member'>
                <div className='member_face'><img src="/assets/memmbers/tomix.jpg" className='rounded' alt="Tomioka Daiki" /></div>
